...
treeview = Treeview(
    window, ("Col0", "Col1", "Col2", "Col3", "Col4", "Col5", "Col6", "Col7")
)
...
treeview.insertChildrenLineData(
    parent_line_item_0, ["00", "01", "02", "03", "04", "05", "06", "07"]
)
treeview.insertChildrenLineData(
    parent_line_item_0, ["00", "01", "02", "03", "04", "05", "06", "07"]
)
...
treeview.insertChildrenLineData(
    parent_line_item_1, ["10", "11", "12", "13", "14", "15", "16", "17"]
)
treeview.insertChildrenLineData(
    parent_line_item_1, ["10", "11", "12", "13", "14", "15", "16", "17"]
)
...
treeview.insertChildrenLineData(
    parent_line_item_2, ["20", "21", "22", "23", "24", "25", "26", "27"]
)
treeview.insertChildrenLineData(
    parent_line_item_2, ["20", "21", "22", "23", "24", "25", "26", "27"]
)
