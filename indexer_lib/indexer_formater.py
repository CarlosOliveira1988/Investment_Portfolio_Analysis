class StackedIndexerFormater:
    ...
    def __assignColumnVariables(self):
        ...
        self.AdjustedDate = DateColumnType(
            self.__StackedConstants.getAdjustedDateTitle()
        )
        self.InterestRate = PercentageColumnType(
    ...
    def __fillNaValues(self):
        for column_variable_string in self.ColumnsVariableList:
            column_type = StackedIndexerFormater.__getattribute__(
...
class OriginalIndexerFormater:
    ...
    def __assignColumnVariables(self):
        ...
        self.YearlyInterestRate = PercentageColumnType(
    ...
    def __fillNaValues(self):
        for column_variable_string in self.ColumnsVariableList:
            column_type = OriginalIndexerFormater.__getattribute__(
                self, column_variable_string
            )
            column_type.fillNaDataFrameColumnValues(self.__FormatedDataFrame)
