...
class EconomicIndexerWindow(Window):
    def __init__(self, auto_show=True):
        ...
        # Window dimensions
        self.setGeometry(QtCore.QRect(0, 0, self.IndexerWidget.getInternalWidth(), self.IndexerWidget.getInternalHeight()))
        self.setFixedSize(self.IndexerWidget.getInternalWidth(), self.IndexerWidget.getInternalHeight())
