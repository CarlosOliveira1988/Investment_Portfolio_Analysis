...
class TreeviewPandas(Treeview):
    ...
    width=Treeview.DEFAULT_WIDTH, height=Treeview.DEFAULT_HEIGHT):
        self.PandasDataFrame = PandasDataFrame
        super().__init__(CentralWidget, list(self.PandasDataFrame), coordinate_X, coordinate_Y, width, height)
